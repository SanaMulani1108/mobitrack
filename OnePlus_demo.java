...
public class OnePlus_demo extends JFrame implements ActionListener
{
	...
	OnePlus_demo()
	{
		...
		i1=new ImageIcon("OnePlus1.jpg");
		i2=new ImageIcon("OnePlus2.jpg");
		i3=new ImageIcon("OnePlus3.jpeg");
		i4=new ImageIcon("OnePlus4.jpeg");
		i5=new ImageIcon("OnePlus5.jpg");
		i6=new ImageIcon("OnePlus6.jpg");

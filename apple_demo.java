...
public class apple_demo extends JFrame implements ActionListener 
{
	//JPanel p1,p2;
	...
	apple_demo()
	{
		...
		i1=new ImageIcon("apple1.jpg");
		i2=new ImageIcon("apple2.jpg");
		i3=new ImageIcon("apple3.jpg");
		i4=new ImageIcon("apple4.jpg");
		i5=new ImageIcon("apple5.jfif");
		i6=new ImageIcon("apple6.jfif");

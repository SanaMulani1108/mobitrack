...
public class redmi_demo extends JFrame implements ActionListener 
{
	//JPanel p1,p2;
	...
	redmi_demo()
	{
		...
		i1=new ImageIcon("redmi1.jfif");
		i2=new ImageIcon("redmi2.jpg");
		i3=new ImageIcon("redmi3.jpg");
		i4=new ImageIcon("redmi4.jpg");
		i5=new ImageIcon("redmi5.jpg");
		i6=new ImageIcon("redmi6.jpg");
		...
		ta1.setBounds(350,100,150,100);
		
		String val2="Redmi K30\n"+"Rs.16,100.00 \n"+"Storage:64GB\n"+"RAM:6GB\n";
